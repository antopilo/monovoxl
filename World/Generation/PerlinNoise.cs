...
using System.Text;
namespace HelloMonoGame.World.Generation
{
    public class PerlinNoise
    {
        ...
        public static float[][] GeneratePerlinNoise(float[][] baseNoise, int octaveCount)
        {
            ...
            float amplitude = 1.00f; float totalAmplitude = 0.0f;
            float[][] perlinNoise = GetEmptyArray(width, height);//an array of floats initialised to 0    //blend noise together  
